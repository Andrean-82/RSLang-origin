export const grupeZero = () => {
    return <HTMLElement>document.getElementById('level_0_number');
};
export const grupeOne = () => {
    return <HTMLButtonElement>document.getElementById('level_1_number');
};
export const grupeTwo = () => {
    return <HTMLButtonElement>document.getElementById('level_2_number');
};
export const grupeThree = () => {
    return <HTMLButtonElement>document.getElementById('level_3_number');
};
export const grupeFour = () => {
    return <HTMLButtonElement>document.getElementById('level_4_number');
};
export const grupeFive = () => {
    return <HTMLButtonElement>document.getElementById('level_5_number');
};
export const blokOne = () => {
    return <HTMLElement>document.querySelector('.blok_one_1');
};
export const blokTwo = () => {
    return <HTMLElement>document.querySelector('.blok_two_1');
};
export const blokThree = () => {
    return <HTMLElement>document.querySelector('.blok_three_1');
};
export const blokFour = () => {
    return <HTMLElement>document.querySelector('.blok_four_1');
};
export const blokFive = () => {
    return <HTMLElement>document.querySelector('.blok_five_1');
};
